// Note: Using a proxy server is recommended to avoid CORS issues in production.
// These URLs are for development and may be unstable.
...
export const FETCH_OFFERS_URL =
  "https://gofoodsserver.onrender.com/api/restaurants/?"; // Same as restaurants, offers are embedded

export const IMG_CDN_URL =
  "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/";

// Removed hardcoded lat/lng, they will be added dynamically by the hooks
export const FETCH_MENU_URL =
  "https://gofoodsserver.onrender.com/api/menu/?restaurantId=";

export const FETCH_CATEGORY_URL =
  "https://gofoodsserver.onrender.com/api/category/?collectionId=";
